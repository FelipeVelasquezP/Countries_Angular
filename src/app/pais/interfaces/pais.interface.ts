...
//
//   const rESTCountriesResponsive = Convert.toRESTCountriesResponsive(json);
//
...
export class Convert {
    public static toRESTCountriesResponsive(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTCountriesResponsive")));
    }

    public static rESTCountriesResponsiveToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCountriesResponsive"))), null, 2);
    }
}
